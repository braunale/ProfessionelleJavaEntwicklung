...
public class WeatherServlet extends HttpServlet {
	...
	/**
	 * @param request
	 *            = given request from the web site
	 * @param response
	 *            = response object that will be filled
	 * @throws ServletException
	 *             at servlet errors
	 * @throws IOException
	 *             at errors with the inputstream
	 */
	@Override
	public final void doGet(final HttpServletRequest request, final HttpServletResponse response)
			throws ServletException, IOException {

		Log.info("Called Weather Servlet");
		...
		if (town != null) {
			...
			Log.error("Servlet was called without a town parameter");
			ErrorMessage error = new ErrorMessage("No Town", "Please call the Servlet with ?town='your town'");
			StringWriter writer = new StringWriter();
			...
			try {
				...
				Log.error("Error while create xml-Error Message: " + e.getMessage());
			}
		}
	...
	/**
	 * @param request
	 *            = request from the web site
	 * @param response
	 *            = response object that will be filled
	 * @throws ServletException
	 *             at problems with the servlet
	 * @throws IOException
	 *             at io problems
	 */
	@Override
