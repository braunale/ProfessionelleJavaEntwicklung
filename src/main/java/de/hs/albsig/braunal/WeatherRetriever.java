...
public final class WeatherRetriever {
	 ...
	 *
	 * @param town
	 *            = Name of the town for which the weather is requested
	 * @return inputStream that contains the weather data
	 * @throws Exception
	 *             if the url could not be accessed
	 */
	public InputStream retrieve(final String town) throws Exception {
		...
		String url = "https://query.yahooapis.com/v1/public/yql?q=select"
				...
				+ "(select%20woeid%20from%20geo.places(1)%20where%20text%3D%22" + town
				+ "%22)%20AND%20u%3D'c'&format=xml&env=store%3A%2F%2" + "Fdatatables.org%2Falltableswithkeys";
